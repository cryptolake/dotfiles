...
beautiful.init(string.format("%s/theme/theme.lua", gears.filesystem.get_configuration_dir()))
...
globalkeys = mytable.join(
	...
	-- X screen locker
	awful.key({ modkey, "Shift" }, "x", function () os.execute("slock") end,
	...
	--Audio
	awful.key({ modkey }, "-", function () awful.spawn("pulsemixer --change-volume -5") end,
	...
	awful.key({ modkey, }, "m",
		function () awful.spawn(terminal .. " -e ncmpcpp") end,
	...
	awful.key({ modkey }, "a", function () awful.spawn(terminal .. " -e pulsemixer") end,
		{description = "Run pulsemixer", group = "launcher"}),

	awful.key({ modkey }, "F1", function () awful.spawn("arandr") end,
